                            ...
                            <div class="anime__details__btn">
                                ...
                                <c:if test="${user ==null}">
                                    <c:if test="${!requestScope.movie.isFree()}">
                                        <a href="/anime-main/AddWishList?idMovie=${requestScope.movie.id}">
                                ...
                                <c:if test="${sessionScope.user !=null }">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${!requestScope.movie.isFree()}">
                                            ...
                                            <button class="add-to-wishlist" data-id="${requestScope.movie.id}" style="color: white"
                                                    id="buyMovie">Mua
                                                ngay ${requestScope.movie.getRenderPrice()} đ
                                            </button>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="anime__details__review">
                        ...
                        <c:if test="${requestScope.availableToRender>0}">
                            <button id="moreComment" onclick="showMore(this,`root0`)" value="${requestScope.rendered}">
